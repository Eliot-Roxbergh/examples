...
void test0()
{
    ...
    set_var(&test_ptr);  // NOTE: you may NOT take &&test, this is not a valid
...
int get_var(int **ret)  // this works
{
    ...
    */
    ...
    /*
     * Any memory we create on the stack will be gone after this function's
     * scope, naturally. But we may return addresses that point to data we did
     * not initialize (not local to this scope). my_secret is local to this file
     * and its address will be valid for longer (local to this file)
     */
    a_ptr = (int *)&my_secret;
